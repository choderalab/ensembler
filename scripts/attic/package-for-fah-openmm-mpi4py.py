...
#
# John D. Chodera <choderaj@mskcc.org> - 16 Mar 2013 - Edited (mpi4py) DLP 7 Jun 2013
...
if __name__ == '__main__':
    ...
    for target in targets:
        ...
        for run_index in range(rank, len(valid_templates), size):
            source_directory = os.path.join(target_directory, valid_templates[run_index])
            generateRun(project_directory, source_directory, run_index, nclones, verbose)
