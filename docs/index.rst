...
*A Python application and library which generates diverse protein
...
molecular simulations, which take advantage of the parallel nature of modern
high-performance computing architectures. This approach is also particularly
beneficial when used in conjunction with recent techniques which can combine
data from multiple independent trajectories to produce kinetic models, such as
Markov state models.
